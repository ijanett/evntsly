events = [
    ...
    {name: "Without Borders Brunch", location: "Travelers Hall", date: "Sun, Aug 18", time: "12:00 PM", description: "Great for those who enjoy traveling and new adventures! Enjoydiverse dishes from around the world."}
]
